...
public class PopupMenu extends RelativePopupWindow {
    ...
    public Button getBtnDelete() {
        btn = (Button) getContentView().findViewById(R.id.btn_delete);
        return btn;
    }

    public Button getBtnRemarks() {
        btn = (Button) getContentView().findViewById(R.id.btn_remarks);
        return btn;
    }
