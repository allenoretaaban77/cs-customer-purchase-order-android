...
import com.fnc.receiving.android.activity.MainActivity;
import com.fnc.receiving.android.callback.VolleyCallback;
import com.fnc.receiving.android.model.Checklist;
...
//        startTimer();
    ...
    public void onDestroy() {
        ...
        startService(new Intent(getBaseContext(), ReceivingService.class));
    }
    ...
    public Runnable postRunnable = new Runnable() {
        ...
        public void run() {
            ...
            /*LinkedList<Ordered> od =  Checklist.getInstance(getApplicationContext())
