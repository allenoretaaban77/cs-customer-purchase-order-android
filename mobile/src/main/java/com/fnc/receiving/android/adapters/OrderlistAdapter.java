...
//            Toast.makeText(context, "Item cannot be deleted", Toast.LENGTH_LONG).show();
        ...
        if (iRs.getOldSku().equals("null")) {
            ...
            holder.cell_qty.setTextColor(context.getResources().getColor(R.color.gray_7));
            holder.cell_unit.setTextColor(context.getResources().getColor(R.color.gray_7));
            holder.cell_description.setTextColor(context.getResources().getColor(R.color.gray_7));
            holder.cell_price.setTextColor(context.getResources().getColor(R.color.gray_7));
            holder.cell_total.setTextColor(context.getResources().getColor(R.color.gray_7));
        }
